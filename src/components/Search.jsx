    ...
    <div className="search relative h-[65rem] px-[5rem] bg-[#081730] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem]">
      ...
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem]">
        ...
        <div className="searchbar flex justify-start w-[100%]">
          ...
          />
          {/* SearchIcon */}
          <div className="searchIcon flex flex-1 items-center rounded-xl ml-4 bg-gradient-to-bl from-[#F3071D] to-[#E600FF] p-4 h-[3rem] hover:cursor-pointer">
            <img
        ...
        <div className="detail flex flex-col mt-5 text-4xl">
          ...
          Effortlessly discover and enjoy your favorite tunes  with our user-friendly music <br />search feature.Whether you're seeking a specific track by name or have a direct URL<br /> in mind, our intuitive search functionality ensures a seamless and efficient experience.
          </span>
        </div>
        {/* Music Player */}
        <VisibilitySensor
